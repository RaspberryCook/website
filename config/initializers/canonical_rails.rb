...
CanonicalRails.setup do |config|
  ...
  # example of url with multiples parameters
  # http://localhost:3000/recipes?utf8=%E2%9C%93&name=a&%5Btype%5D=Entr%C3%A9e&%5Bseason%5D=Toutes&%5Ballergens%5D%5B23%5D=1&commit=Rechercher
  config.whitelisted_parameters = [:name, :type, :season, :allergens]
